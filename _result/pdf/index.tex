...
\chapter{What we are talking about}\section{Illustration example}\section{Evaluation criteria}
\begin{itemize}
\item constraints: make a list and evaluate all solutions?
\item flexibility: no constraint on the source code
\item granularity: method, AST, other?
\item integration: is it integrated into the system?
\item self preservation: case of proxies?
\end{itemize}
